...
const experiences = [
  {
    ...
    type: "Full-time",
    tech: ["PHP (Laravel)", "Vue.js", "Node.js", "Python (Django)", "MySQL", "PostgreSQL", "REST/SOAP APIs", "Geospatial Mapping"],
  ...
  },
  {
    ...
    type: "Project-based",
    tech: ["Node.js", "Laravel", "Vue.js", "MySQL", "PostgreSQL"],
  ...
  {
    title: "Web Systems Engineer (GovTech)",
    company: "Sekretaris DPRD Kabupaten Sleman",
    location: "Sleman, Yogyakarta, Indonesia",
    period: "Jan 2020 - Oct 2022",
    type: "Full-time",
    tech: ["Node.js", "React.js", "MySQL", "PostgreSQL"],
    challenge: "DPRD legislative data systems were fragmented across manual and legacy tools, hampering report generation and public transparency.",
    role: "Led backend, frontend, and integration workflows for the DPRD legislative management system.",
    action: "Developed and maintained using Node.js, React.js, PostgreSQL, MySQL; built REST APIs and data pipelines integrating agenda, voting, and e-Report data.",
  },
  {
    title: "Web Systems Engineer (GovTech)",
    company: "PT. Syariah Al Amin Life Insurance",
    location: "South Jakarta, Indonesia",
    period: "Oct 2018 - Oct 2019",
    type: "Full-time",
    tech: ["Node.js", "Laravel", "CodeIgniter", "Android (Java)", "MySQL"],
    challenge: "Insurance core systems were siloed, blocking real-time policy and claims visibility across channels.",
    role: "Led implementation of backend, frontend, and integration workflows for sharia insurance digital systems.",
    action: "Built and maintained using Node.js, Laravel, CodeIgniter, and Android (Java), MySQL; integrated web portals with mobile apps via REST APIs for policy and claims workflows.",
  },
];
